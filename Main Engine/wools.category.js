...
async function fetchProducts() {
        ...
        for(let i=1; i<4 ; i++){
          const pageUrl=`https://www.woolworths.com.au/shop/browse/snacks-confectionery/confectionery/chocolate-boxes-gifts?pageNumber=${i}`
          ...
          productPromises.map((product) =>{
              ...
              product["mainCategoryUrl"]='https://www.woolworths.com.au/shop/browse/snacks-confectionery/confectionery/';
          ...
          fs.writeFileSync('./Wools_ChocolateBox_Products.json', productsString);
